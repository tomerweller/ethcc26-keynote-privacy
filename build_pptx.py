...
add_title_slide(prs,
    ...
    notes="Hi, I'm Tomer, CPO at the Stellar Development Foundation. I've been in crypto for almost 9 years and for the last couple of years, privacy has been one of my focal points. This talk is about what we've learned in discussions with institutions about privacy."
)
...
add_bullets_slide(prs, "Privacy Dead Ends", [
    ...
    notes="""When we started looking at privacy for Stellar, we realized that most privacy solutions today end up in one of two failure modes, or "dead ends".

All-or-Nothing: Privacy solutions that have two modes: full transparency or full privacy, nothing in between. This can take the shape of a smart contract pool, an L2 or an appchain - but the premise is the same: all or nothing. Unfortunately, this doesn't leave room for nuance for regulated financial institutions to engage with.
...
# --- Slide 6: The Privacy Stack ---
add_bullets_slide(prs, "The Privacy Stack", [
    ("Transparency first", "the base layer stays open and auditable"),
    ("Building blocks for privacy", "primitives that enable privacy, without enshrining a specific type"),
    ("Privacy protocols on top", "different guarantees, different controls, many of them"),
],
    notes="""We think that the answer is simple: a clear architectural separation.
...
And that's the final layer: Privacy protocols on top. Different protocols for different privacy guarantees, different administrative controls, different underlying tech. Most importantly: there will be many of them.
